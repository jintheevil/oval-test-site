      ...
      <main id={"about"}>
        <div className={"flex gap-8 px-40 mb-10"}>
          ...
          <div className={"text-black"}>
            ...
            <p>
              Oval is actively involved in trading/distribution of Oval Japan manufactured product & metering system and International Branded Product to Oil & Gas, Petrochemical, Chemical, Power, Water, F&B and various general industries. We specialize in providing measurement and metering solutions to these industries. Our parent company and subsidiaries undertake projects in many countries around the world. Our complete team of engineering professionals offers expert design and development right up to commissioning, installation testing and training.
            </p>
            <h1 className={"text-4xl mb-4 mt-4"}>Our Mission</h1>
            <p>
        ...
        <div className={"flex gap-8 px-40"}>
          <div className={"text-black text-right"}>
            <h1 className={"text-4xl mb-4"}>Quality Standards & Policy</h1>
            <p className={"italic"}>
